...
struct array_char* init(int size){
    struct array_char* arr=(struct array_char*)malloc(sizeof(array_char));
...
struct array_char* find_extens(char *name){
    int n=0;
...
struct array_char* joined_name(char *path,struct array_char* file_ext){
